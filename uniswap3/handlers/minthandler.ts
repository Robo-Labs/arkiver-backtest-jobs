import { formatUnits, fromHex, numberToHex, toHex, Address } from 'npm:viem'
...
export const POOLSYMBOLS: {[key: Address]: string} = {'0x4e0924d3a751be199c426d52fb1f2337fa96f736': 'UNI3-LUSD/USDC 0.05%'}
...
export const onMint: EventHandlerFor<typeof UNI3PoolAbi, "Mint"> = async (
    ...
    console.log('mint', event.blockNumber)
