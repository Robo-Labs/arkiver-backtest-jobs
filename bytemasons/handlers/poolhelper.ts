...
import { velodromeV2Pool } from "../abis/velodromeV2Pool.ts";
...
export const getReserves = async (client: PublicClient, pool: string, block: bigint) => {
	console.log(`getReserves pool: ${pool}`)
	return await client.readContract({
		abi: velodromeV2Pool,
		address: pool,
